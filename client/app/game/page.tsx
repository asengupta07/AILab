  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <main className="relative z-10">
        {/* Header */}
        <header className="container mx-auto py-4 sm:py-6 px-2 sm:px-4 flex flex-col sm:flex-row justify-between items-center gap-4">
        ...
        <section className="container mx-auto px-2 sm:px-4 py-6 sm:py-10">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-6 sm:mb-8">
              ...
              />
              <p className="text-lg sm:text-xl text-gray-300 mt-4">Can you tell if this image is real or generated by AI?</p>
            </div>
              ...
              <Card className="relative bg-gray-900/70 border-gray-800 backdrop-blur-sm overflow-hidden">
                {loading ? (
                  <div className="flex flex-col items-center justify-center p-10 sm:p-20">
                    <Loader2 className="h-12 sm:h-16 w-12 sm:w-16 text-purple-500 animate-spin mb-4" />
                  ...
                  <div>
                    ...
                    <div className="relative w-full h-[60vh] sm:h-[70vh] overflow-hidden">
                      ...
                      {showAiThinking && (
                        <div className="absolute inset-0 bg-black/80 flex flex-col items-center justify-center p-4 sm:p-8 backdrop-blur-sm">
                          <div className="w-16 sm:w-24 h-16 sm:h-24 rounded-full bg-gradient-to-r from-cyan-500 to-purple-600 flex items-center justify-center mb-4 sm:mb-6 animate-pulse">
                            <Brain className="h-8 sm:h-12 w-8 sm:w-12 text-white" />
                          </div>
                          <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-4 text-white">AI is analyzing...</h3>
                          <p className="text-sm sm:text-base text-gray-300 mb-4 sm:mb-6 text-center px-4">{aiThinkingText}</p>
                          <div className="w-full max-w-md mb-2">
                            <Progress value={aiThinkingProgress} className="h-2 bg-gray-700" />
                          </div>
                          <p className="text-xs sm:text-sm text-gray-400">{aiThinkingProgress}% complete</p>
                        </div>
                      )}
                      ...
                      {showResult && (
                        <div className="absolute inset-0 bg-black/80 flex flex-col items-center justify-center p-4 sm:p-8 backdrop-blur-sm">
                          <div
                            className={`w-16 sm:w-24 h-16 sm:h-24 rounded-full flex items-center justify-center mb-4 sm:mb-6 ${userGuess === currentImage?.trueClass ? "bg-green-500 animate-bounce" : "bg-red-500 animate-shake"}`}
                          >
                            {userGuess === currentImage?.trueClass ? (
                              <Sparkles className="h-8 sm:h-12 w-8 sm:w-12 text-white" />
                            ) : (
                              <AlertTriangle className="h-8 sm:h-12 w-8 sm:w-12 text-white" />
                            )}
                          </div>

                          <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-4 text-white text-center">
                            {userGuess === currentImage?.trueClass ? "You got it right!" : "Not quite right!"}
                          </h3>

                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 w-full max-w-md mb-6 sm:mb-8">
                            <div className="text-center">
                              <p className="text-sm sm:text-base text-gray-400 mb-2">The image was:</p>
                              <Badge
                                className={`text-base sm:text-lg py-1 px-4 ${currentImage?.trueClass === "real" ? "bg-green-900/50 text-green-300 border-green-500" : "bg-red-900/50 text-red-300 border-red-500"}`}
                              >
                            ...
                            <div className="text-center">
                              <p className="text-sm sm:text-base text-gray-400 mb-2">AI guessed:</p>
                              <Badge
                                className={`text-base sm:text-lg py-1 px-4 ${currentImage?.predictedClass === currentImage?.trueClass ? "bg-green-900/50 text-green-300 border-green-500" : "bg-red-900/50 text-red-300 border-red-500"}`}
                              >
                          ...
                          <div className="w-full max-w-md flex justify-center">
                            <Button
                              ...
                              className="text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6 bg-gradient-to-r from-cyan-500 to-purple-600 hover:from-cyan-600 hover:to-purple-700 rounded-full transition-all duration-300 shadow-[0_0_15px_rgba(8,145,178,0.5)] relative z-10"
                            >
                              Next Image
                            </Button>
                          </div>
                    ...
                    {!userGuess && !showAiThinking && !showResult && (
                      <div className="p-4 sm:p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
                        <div className="text-center sm:text-left">
                          <h3 className="text-lg sm:text-xl font-bold mb-1 text-white">What do you think?</h3>
                          <p className="text-sm sm:text-base text-gray-400">Trust your instincts and make a guess</p>
                        </div>

                        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto">
                          <Button
                            onClick={() => handleGuess("real")}
                            className="w-full sm:w-auto px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white rounded-full transition-all duration-300 shadow-[0_0_15px_rgba(22,163,74,0.3)]"
                          >
                          ...
                          <Button
                            ...
                            className="w-full sm:w-auto px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white rounded-full transition-all duration-300 shadow-[0_0_15px_rgba(220,38,38,0.3)]"
                          >
            ...
            <div className="mt-4 p-3 sm:p-4 bg-purple-900/20 rounded-lg border border-purple-500/30 backdrop-blur-sm">
                <div className="flex items-center gap-2 text-purple-300">
                  <div className="flex items-center gap-2 pe-4 sm:pe-10">
            ...
            <div className="mt-8 sm:mt-10 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
              <Card className="bg-gray-900/50 border-gray-800 p-4 sm:p-6 backdrop-blur-sm">
                <div className="flex flex-col items-center">
                  <div className="h-10 sm:h-12 w-10 sm:w-12 rounded-full bg-cyan-900/50 flex items-center justify-center mb-2 sm:mb-3">
                    <Eye className="h-5 sm:h-6 w-5 sm:w-6 text-cyan-400" />
                  </div>
                  <h3 className="text-base sm:text-lg font-bold mb-1 text-cyan-300">Your Score</h3>
              ...
              <Card className="bg-gray-900/50 border-gray-800 p-4 sm:p-6 backdrop-blur-sm">
                <div className="flex flex-col items-center">
                  <div className="h-10 sm:h-12 w-10 sm:w-12 rounded-full bg-purple-900/50 flex items-center justify-center mb-2 sm:mb-3">
                    <Brain className="h-5 sm:h-6 w-5 sm:w-6 text-purple-400" />
                  </div>
                  <h3 className="text-base sm:text-lg font-bold mb-1 text-purple-300">AI Score</h3>
                  <p className="text-2xl sm:text-3xl font-bold text-white">
              ...
              <Card className="bg-gray-900/50 border-gray-800 p-4 sm:p-6 backdrop-blur-sm">
                <div className="flex flex-col items-center">
                  <div className="h-10 sm:h-12 w-10 sm:w-12 rounded-full bg-pink-900/50 flex items-center justify-center mb-2 sm:mb-3">
                    <Lightbulb className="h-5 sm:h-6 w-5 sm:w-6 text-pink-400" />
                  </div>
                  <h3 className="text-base sm:text-lg font-bold mb-1 text-pink-300">Current Streak</h3>
